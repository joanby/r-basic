...
Pasemos ahora a calcular el intervalo crítico.
...
Ahora, ya podemos calcular una estimación de la media de los datos "reales".
...
M #Aproximación de la media de los datos "reales"
mean(cw) #Media de los datos "reales"
```
...
histRel(cw,L)
curve(dnorm(x, mean(cw), sd(cw)), col="cyan1", lty=4, lwd=2,
add=TRUE)
legend("topright", lwd=c(2,2), lty=c(1,4), col=c("purple","cyan1"), legend=c("densidad estimada","densidad normal"))
```
