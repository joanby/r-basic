...
El conocido <l class = "definition">diagrama de caja</l> o <l class = "definition">box plot</l> es un tipo de gráfico quebásicamente, remarca 5 valores estadísticos:
...
boxplot(circumference~Tree, data = Orange, ylab = "Circunferencia del tronco (mm)", 
        main = "Boxplot de los naranjos en funciónd el tipo de árbol")
```
...
Dicha función aplicada a un boxplot, nos produce una list. Podéis ver esta list si introducí por consola la siguiente instrucción: `str(boxplot(circumference~Tree, data = Orange))` Destacaremos dos de sus componenetes aquí:
